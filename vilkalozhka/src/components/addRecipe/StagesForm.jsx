    ...
    <div className="addInformationForm">
      <div className="formHeader">
        ...
        <div className="scrollBar">
          ...
          <div className="line thirdPage"></div>
        </div>
      </div>
      ...
      <div className="addIngredients__info">
        ...
        <p>
          Чтобы создать понятную инструкцию по приготовлению рецепта,
          постарайтесь максимально подробно описать каждый этап. К
          соответствующему этапу загрузите изображение, которое наглядно
          показывает этап. Размер изображения не должен превышать 4мб.
          Изображение может быть в формате <span>jpg, png, svg, webp, pdf</span>
          .
        </p>
      </div>
      ...
      <div className="addInformation__inputs">
        {steps.map((step, index) => (
          <div key={index} className="step">
            <div className="ingredient__field">
